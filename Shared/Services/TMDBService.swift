...
public enum MockData {
    public static let cinemaMovies: [MediaItem] = [
        ...
        MediaItem(
            ...
            posterPath: "/f4hdIed8vh10O8TkQ1CkHS8MQ3G.jpg",
            backdropPath: "/eAouIDoMDhLetm6CtmDKIGEaaCi.jpg",
            voteAverage: 7.7,
            voteCount: 590,
    ...
    public static let freshFromTheatres: [MediaItem] = [
        MediaItem(
            ...
            voteAverage: 8.3,
            voteCount: 6564,
            releaseDateString: "2024-09-12",
            genreNames: ["Family", "Animation", "Science Fiction"],
            runtimeMinutes: 102,
            tagline: "Discover your true nature.",
            certification: "PG",
            streamingProviders: [.appleTV, .primeVideo],
            trailers: [VideoTrailer(id: "tr_1184918", name: "Official Trailer", key: "oEC84M0GMdg")],
            cast: [CastMember(id: 1267329, name: "Lupita Nyong'o", character: "Roz / Rummage (voice)"), CastMember(id: 1253360, name: "Pedro Pascal", character: "Fink (voice)")],
        ...
        MediaItem(
            ...
            voteAverage: 7.2,
            voteCount: 4869,
            releaseDateString: "2024-08-13",
            genreNames: ["Horror", "Science Fiction"],
            runtimeMinutes: 119,
            tagline: "In space, no one can hear you.",
            certification: "R",
            streamingProviders: [.disneyPlus, .appleTV],
            trailers: [VideoTrailer(id: "tr_945961", name: "Official Trailer", key: "bQlwYnouC98")],
            cast: [CastMember(id: 1683343, name: "Cailee Spaeny", character: "Rain"), CastMember(id: 2761308, name: "David Jonsson", character: "Andy")],
        ...
        MediaItem(
            ...
            posterPath: "/pjnD08FlMAIXsfOLKQbvmO0f0MD.jpg",
            backdropPath: "/58D6ZAvOKxlHjyX9S8qNKSBE9Y.jpg",
            voteAverage: 6.8,
            voteCount: 3152,
            releaseDateString: "2024-07-10",
            genreNames: ["Action", "Thriller"],
            runtimeMinutes: 123,
            tagline: "Chase. Ride. Survive.",
            certification: "PG-13",
            streamingProviders: [.appleTV, .primeVideo],
            trailers: [VideoTrailer(id: "tr_718821", name: "Official Trailer", key: "5fuQUrEW8oc")],
            cast: [CastMember(id: 2230991, name: "Daisy Edgar-Jones", character: "Kate"), CastMember(id: 83271, name: "Glen Powell", character: "Tyler")],
            logoPath: "/ySUehfaAboyWvi4o7AhqehyPzgd.png",
            inCinemas: false
        ),
        MediaItem(
            id: 533535,
            ...
            voteAverage: 7.6,
            voteCount: 9411,
            releaseDateString: "2024-07-24",
            genreNames: ["Action", "Comedy", "Science Fiction"],
            runtimeMinutes: 128,
            tagline: "Come together.",
            certification: "R",
            streamingProviders: [.disneyPlus],
            trailers: [VideoTrailer(id: "tr_533535", name: "Official Trailer", key: "dyq7hMlF9iY")],
            cast: [CastMember(id: 10859, name: "Ryan Reynolds", character: "Wade Wilson / Deadpool / Nicepool"), CastMember(id: 6968, name: "Hugh Jackman", character: "Logan / Wolverine")],
        ...
        MediaItem(
            ...
            voteAverage: 6.9,
            voteCount: 3296,
            releaseDateString: "2024-09-04",
            genreNames: ["Comedy", "Fantasy"],
            runtimeMinutes: 105,
            tagline: "The ghost with the most is back.",
            certification: "PG-13",
            streamingProviders: [.max, .appleTV],
            trailers: [VideoTrailer(id: "tr_917496", name: "Official Trailer", key: "EVm9EEpq4vU")],
            cast: [CastMember(id: 2232, name: "Michael Keaton", character: "Beetlejuice"), CastMember(id: 1920, name: "Winona Ryder", character: "Lydia")],
        ...
        MediaItem(
            ...
            backdropPath: "/fypydCipcWDKDTTCoPucBsdGYXW.jpg",
            voteAverage: 7.1,
            voteCount: 4440,
            releaseDateString: "2024-05-08",
            genreNames: ["Science Fiction", "Adventure", "Action"],
            runtimeMinutes: 145,
            tagline: "No one can stop the reign.",
            certification: "PG-13",
            streamingProviders: [.disneyPlus],
            trailers: [VideoTrailer(id: "tr_653346", name: "Official Trailer", key: "Q45wW7AmgC0")],
            cast: [CastMember(id: 1586047, name: "Owen Teague", character: "Noa"), CastMember(id: 2146942, name: "Freya Allan", character: "Nova / Mae")],
            logoPath: "/odfQQNwtLKPlTPahXUPreSUT0YV.png",
            inCinemas: false
        ),
        MediaItem(
            id: 1022789,
            ...
            voteAverage: 7.5,
            voteCount: 6963,
            releaseDateString: "2024-06-11",
            genreNames: ["Animation", "Adventure", "Comedy"],
            runtimeMinutes: 97,
            tagline: "Make room for new emotions.",
            certification: "PG",
            streamingProviders: [.disneyPlus],
            trailers: [VideoTrailer(id: "tr_1022789", name: "Official Trailer", key: "QGFELnpig2M")],
            cast: [CastMember(id: 56322, name: "Amy Poehler", character: "Joy (voice)"), CastMember(id: 1903874, name: "Maya Hawke", character: "Anxiety (voice)")],
            logoPath: "/h40hblm8J1if7T2CBMjCD85HwuD.png",
            inCinemas: false
        ),
        MediaItem(
            id: 519182,
            ...
            voteAverage: 7.0,
            voteCount: 3353,
            releaseDateString: "2024-06-20",
            genreNames: ["Animation", "Comedy", "Action"],
            runtimeMinutes: 94,
            tagline: "Things just got a little more despicable.",
            certification: "PG",
            streamingProviders: [.appleTV, .primeVideo],
            trailers: [VideoTrailer(id: "tr_519182", name: "Official Trailer", key: "rq68v4Q6aSo")],
            cast: [CastMember(id: 4495, name: "Steve Carell", character: "Gru (voice)"), CastMember(id: 41091, name: "Kristen Wiig", character: "Lucy (voice)")],
            logoPath: "/89h1vVNsvFejMxhbrxPO9raMnbl.png",
            inCinemas: false
        ),
        MediaItem(
            id: 762441,
            ...
            posterPath: "/hU42CRk14JuPEdqZG3AWmagiPAP.jpg",
            backdropPath: "/6XjMwQTvnICBz6TguiDKkDVHvgS.jpg",
            voteAverage: 6.6,
            voteCount: 3552,
            releaseDateString: "2024-06-26",
            genreNames: ["Horror", "Science Fiction", "Thriller"],
            runtimeMinutes: 100,
            tagline: "Hear how it all began.",
            certification: "PG-13",
            streamingProviders: [.paramountPlus, .appleTV],
            trailers: [VideoTrailer(id: "tr_762441", name: "Official Trailer", key: "kshP9EQX-Ss")],
            cast: [CastMember(id: 1267329, name: "Lupita Nyong'o", character: "Samira"), CastMember(id: 1597365, name: "Joseph Quinn", character: "Eric")],
            logoPath: "/hdlpXXbRWPlp5J5ni1qM7D7vezp.png",
            inCinemas: false
        ),
        MediaItem(
            id: 823464,
            ...
            backdropPath: "/gvLG3Fnznkxl4SmYfcK8gUuqxM8.jpg",
            voteAverage: 7.0,
            voteCount: 4844,
            releaseDateString: "2024-03-27",
            genreNames: ["Action", "Adventure", "Science Fiction"],
            runtimeMinutes: 115,
            tagline: "Rise together or fall alone.",
            certification: "PG-13",
            streamingProviders: [.max, .appleTV],
            trailers: [VideoTrailer(id: "tr_823464", name: "Official Trailer", key: "m2u6RfmTXt0")],
            cast: [CastMember(id: 15556, name: "Rebecca Hall", character: "Ilene Andrews"), CastMember(id: 226366, name: "Brian Tyree Henry", character: "Bernie Hayes")],
            logoPath: "/4skeKFtpdXvHFj7ab86cU20nju0.png",
            inCinemas: false
        ),
        MediaItem(
            id: 786892,
            ...
            backdropPath: "/raph7qjAGTMXaIjVxt6ZDSXRzUr.jpg",
            voteAverage: 7.4,
            voteCount: 5171,
            ...
            certification: "R",
            streamingProviders: [.max, .appleTV],
            trailers: [VideoTrailer(id: "tr_786892", name: "Official Trailer", key: "LYV3001u574")],
            cast: [CastMember(id: 1397778, name: "Anya Taylor-Joy", character: "Furiosa"), CastMember(id: 74568, name: "Chris Hemsworth", character: "Dementus")],
            logoPath: "/z1wMCU7yPf6YELf46S2ml8XFDdR.png",
            inCinemas: false
        ),
        MediaItem(
            id: 693134,
            ...
            certification: "PG-13",
            streamingProviders: [.max, .appleTV],
            trailers: [VideoTrailer(id: "tr_693134", name: "Official Trailer", key: "p-4Xgcuwb00")],
            cast: [CastMember(id: 1190668, name: "Timothée Chalamet", character: "Paul Atreides"), CastMember(id: 505710, name: "Zendaya", character: "Chani")],
            logoPath: "/eYvF1LhPKuoBxOAmWjFTAK7EPWl.png",
            inCinemas: false
        )
    ]
